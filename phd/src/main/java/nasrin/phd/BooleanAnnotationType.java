...
public class BooleanAnnotationType extends AbstractAttributeCalculator{
	 ...
	 */
	public BooleanAnnotationType(String name, String annotationSetName, String annotationType) {
		setName(name);
